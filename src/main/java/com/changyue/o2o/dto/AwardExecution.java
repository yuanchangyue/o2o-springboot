...
public class AwardExecution {
    ...
    //分页
    private PageInfo<Award> awardPageInfo;
    ...
    public AwardExecution(AwardStateEnum stateEnum, PageInfo<Award> awardPageInfo) {
        this.state = stateEnum.getState();
        this.stateInfo = stateEnum.getStateInfo();
        this.awardPageInfo = awardPageInfo;
    }
    ...
    public PageInfo<Award> getAwardPageInfo() {
        return awardPageInfo;
    }

    public void setAwardPageInfo(PageInfo<Award> awardPageInfo) {
        this.awardPageInfo = awardPageInfo;
    }
}
