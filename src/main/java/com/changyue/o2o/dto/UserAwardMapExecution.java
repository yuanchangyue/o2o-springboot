...
public class UserAwardMapExecution {
	...
	private PageInfo<UserAwardMap> userAwardMapPageInfo;
	...
	public UserAwardMapExecution(UserAwardMapStateEnum stateEnum, PageInfo<UserAwardMap> userAwardMapPageInfo) {
		this.state = stateEnum.getState();
		this.stateInfo = stateEnum.getStateInfo();
		this.userAwardMapPageInfo = userAwardMapPageInfo;
	}
	...
	public PageInfo<UserAwardMap> getUserAwardMapPageInfo() {
		return userAwardMapPageInfo;
	}

	public void setUserAwardMapPageInfo(PageInfo<UserAwardMap> userAwardMapPageInfo) {
		this.userAwardMapPageInfo = userAwardMapPageInfo;
	}
}
